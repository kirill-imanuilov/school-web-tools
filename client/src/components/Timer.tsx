...
export function Timer() {
    ...
    useEffect(() => {
        if (!isStopped && !isPaused){
            if (isStarted && (timerSeconds > 0 || timerMinutes > 0 || timerHours > 0)) {
                setTimeout(() => {decreaseTimerSeconds()}, 1000);
            }
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className='set-time-item set-hours'
                >
                    <button
                        className='timer-arrow-button'
                        onClick={increaseTimerHours}
                    >
                        <ArrowUpIMG
                            className='timer-arrow-img'/>
                    </button>
                    { timerHours }
                    <button
                        className='timer-arrow-button'
                        onClick={decreaseTimerHours}
                    >
                        <ArrowDownIMG
                            className='timer-arrow-img'/>
                    </button>
                ...
                <div
                    className='set-time-item set-minutes'
                >
                    <button
                        className='timer-arrow-button'
                ...
                <div
                    className='set-time-item set-seconds'
                >
                    <button
                        className='timer-arrow-button'
